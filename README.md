...
- OpenAI (generate API Key to use it): [https://platform.openai.com/api-keys] Need pay to use it [https://platform.openai.com/docs/guides/rate-limits/error-mitigation]
